...
export default function EmailContent({ email, setOpenEmail }) {
  ...
  const openEmailDate = `${sendDate.toDateString()}, ${sendDate.toLocaleDateString()}`

  return (
    <div className="p-2 md:p-4 absolute lg:relative h-full w-full bg-gray-50
     dark:bg-gray-700 text-gray-900 dark:text-gray-50 grow-[2] basis-96">
